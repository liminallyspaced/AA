...
)
{
  if (
    ...
    || NewCollisionShape == static_cast<EGenCollisionShape>(CurrentRootCollisionShape)
    && GetValidExtent(NewCollisionShape, Extent).Equals(CurrentRootCollisionExtent, 0.01f)
  )
  {
    checkGMC(PawnOwner)
