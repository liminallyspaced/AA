...
public:
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "SKGAttachment | AttachmentInterfaceEvents")
	void OnAttachmentChanged(USKGAttachmentComponent* AttachmentComponent);
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "SKGAttachment | AttachmentInterface")
	UStaticMeshComponent* GetMeshStatic();
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "SKGAttachment | AttachmentInterface")
	USkeletalMeshComponent* GetMeshSkeletal();
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "SKGAttachment | AttachmentInterface")
	void MoveForwardPosition(uint8 Amount);
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "SKGAttachment | AttachmentInterface")
	void MoveBackwardPosition(uint8 Amount);
	// Only used if attaching directly to another actor (bAttachToParentActor is true)
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "SKGAttachment | AttachmentInterface")
	void SetRelativeToOffset(AActor* RelativeTo);
