...
protected:
	...
	// If true will attach to parent (such as firearm or character) directly to allow for welding. False attaches to this component
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SKGAttachment | Customization")
	bool bAttachToParentActor;
	// If attaching to parent mesh, weld the attachment
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SKGAttachment | Customization", meta = (EditCondition = "bAttachToParentActor"))
	bool bWeldAttachment;
	...
	FName AttachParentActorSocketName;
...
public:
	...
	**/
	...
	UFUNCTION(BlueprintPure, Category = "SKGAttachment | Attachment")
	bool AttachToParentActor() const { return bAttachToParentActor; }
