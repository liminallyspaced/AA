...
{
	GENERATED_BODY()
	UPROPERTY(BlueprintReadOnly, Category = "SKGAttachment | AttachmentData")
...
struct FSKGAttachmentRandomDefault
{
	...
	// If true, will allow for no attachment to be spawned as a possibility
...
struct FSKGDataAssetAttachment
{
	...
	// If false, it will not be used as part of the compatibility system
