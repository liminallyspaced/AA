...
#define MAX_PartStack 4

UCLASS()
class ULTIMATEFPSFRAMEWORK_API ASKGPart : public ASKGAttachmentActor, public ISKGFirearmAttachmentsInterface, public ISKGFirearmPartsInterface
{
	GENERATED_BODY()
