...
public:
	...
	bool DoesMuzzleSocketExist() { return AttachmentMesh.IsValid() ? AttachmentMesh->DoesSocketExist(MuzzleSocket) : false; }
	UFUNCTION(BlueprintCallable, Category = "SKGFPSFramework | Default")
	bool IsSuppressor() const { return  bIsSuppressor; }
	UFUNCTION(BlueprintCallable, Category = "SKGFPSFramework | Ammo")
	ASKGMuzzle* GetMuzzleAttachment() { return this; }
