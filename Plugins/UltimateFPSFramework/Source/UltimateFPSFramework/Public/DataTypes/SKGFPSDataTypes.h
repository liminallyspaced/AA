...
struct FSKGAimCameraSettings
{
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SKGFPSFramework")
	bool bUseFixedCameraDistance = false;
};
...
static const FString LeanCurveRelaxConfGraphPath = "RepLeanCurve/LeanCurveRelax";
USTRUCT(BlueprintType)
...
struct FSKGCollisionSettings
{
	...
	// Smaller is less push
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SKGFPSFramework")
	float MaxCollisionPush = -25.0f;
	/* After breaking down from short stock into collision pose, how much additional push do you want the
	 *	on the Y axis before hitting the MaxSollisionPush (smaller value = closer to wall, bigger value = further from wall)
	 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SKGFPSFramework")
	float CollisionPosePushMultiplier = 1.4f;
	// Higher value is how much further the short stock will go
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SKGFPSFramework")
	float ShortStockMaxDistance = 1.0f;
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SKGFPSFramework")
...
struct FSKGCurveAndShakeSettings
{
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "SKGFPSFramework")
	float ShakeCurveMultplier = 1.0f;
