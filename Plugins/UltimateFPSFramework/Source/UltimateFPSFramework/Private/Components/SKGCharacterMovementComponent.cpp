...
USKGCharacterMovementComponent::USKGCharacterMovementComponent()
{
	...
	DefaultWalkSpeedMultiplier = 1.0f;
}
...
void USKGCharacterMovementComponent::BeginPlay()
{
	...
	RequestedWalkSpeedMultiplier = FMath::Clamp(DefaultWalkSpeedMultiplier, MinMaxWalkSpeedMultiplier.Min, MinMaxWalkSpeedMultiplier.Max);
}
...
{
	RequestedWalkSpeedMultiplier = FMath::Clamp(WalkSpeedMultiplier, MinMaxWalkSpeedMultiplier.Min, MinMaxWalkSpeedMultiplier.Max);
}
